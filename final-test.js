// ============================================
// TEST FINAL - Atelier A2: Reflexivpronomen im Dativ
// Claudia Toth · 15 întrebări (regula + reflexiv Dativ + Körperteile + traducere)
// ============================================

const finalTestData = [
    // ⚡ Regula (4)
    { type: 'multiple', category: '⚡ Regula', question: 'Reflexivul este la Dativ (mir) atunci când:', options: ['mai e un obiect direct', 'nu e niciun obiect', 'verbul e modal', 'e la plural'], correct: 'mai e un obiect direct', explanation: 'Două obiecte → reflexivul trece la Dativ.' },
    { type: 'luckentext', category: '⚡ Regula', question: 'Completează (fără alt obiect → Akkusativ):', sentence: 'Ich wasche <strong>______</strong>.', translation: 'reflexiv, eu (fără obiect)', accept: ['mich'], correct: 'mich', explanation: 'Fără obiect → Akkusativ → mich.' },
    { type: 'luckentext', category: '⚡ Regula', question: 'Completează (cu obiect „die Hände" → Dativ):', sentence: 'Ich wasche <strong>______</strong> die Hände.', translation: 'reflexiv, eu (cu obiect)', accept: ['mir'], correct: 'mir', explanation: 'Cu un obiect direct → Dativ → mir.' },
    { type: 'multiple', category: '⚡ Regula', question: 'Care propoziție este CORECTĂ?', options: ['Ich kaufe mir ein Eis.', 'Ich kaufe mich ein Eis.', 'Ich kaufe mein Eis mir.', 'Ich mir kaufe ein Eis.'], correct: 'Ich kaufe mir ein Eis.', explanation: 'sich (Dat) etwas kaufen → Ich kaufe mir ein Eis.' },

    // 🫳 Dativ mir/dir (4)
    { type: 'luckentext', category: '🫳 Dativ mir/dir', question: 'Completează (Dativ, „ich"):', sentence: 'Ich wünsche <strong>______</strong> ein Fahrrad.', translation: 'reflexiv, eu (sich wünschen)', accept: ['mir'], correct: 'mir', explanation: 'sich (Dat) etwas wünschen → mir.' },
    { type: 'luckentext', category: '🫳 Dativ mir/dir', question: 'Completează (Dativ, „du"):', sentence: 'Was wünschst du <strong>______</strong>?', translation: 'reflexiv, tu', accept: ['dir'], correct: 'dir', explanation: 'du → dir.' },
    { type: 'multiple', category: '🫳 Dativ mir/dir', question: 'La „sich etwas leisten", reflexivul este:', options: ['Dativ (mir)', 'Akkusativ (mich)', 'Nominativ', 'Genitiv'], correct: 'Dativ (mir)', explanation: 'sich (Dat) etwas leisten → Ich kann mir das leisten.' },
    { type: 'luckentext', category: '🫳 Dativ mir/dir', question: 'Completează (sich merken, imperativ „du"):', sentence: '<strong>______</strong> dir das!', translation: 'verbul (a memora, imperativ)', accept: ['merk', 'merke'], correct: 'Merk', explanation: 'Imperativ du: Merk dir das!' },

    // 🪥 Körperteile (3)
    { type: 'multiple', category: '🪥 Körperteile', question: '„Ich putze mir ____ Zähne." — ce pui?', options: ['die', 'meine', 'mir', 'der'], correct: 'die', explanation: 'Cu Körperteile: articol (die), NU posesiv (meine).' },
    { type: 'multiple', category: '🪥 Körperteile', question: 'Cu părțile corpului folosim:', options: ['reflexiv Dativ + articol (die)', 'pronume posesiv (meine)', 'doar Akkusativ', 'fără reflexiv'], correct: 'reflexiv Dativ + articol (die)', explanation: 'Ich wasche mir die Hände (NU meine Hände).' },
    { type: 'luckentext', category: '🪥 Körperteile', question: 'Completează (articolul, NU posesiv):', sentence: 'Ich wasche mir <strong>______</strong> Hände.', translation: 'die Hände — articol hotărât', accept: ['die'], correct: 'die', explanation: 'Reflexivul (mir) arată deja că sunt mâinile tale → die Hände.' },

    // 🗣️ Traducere (4)
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Îmi cumpăr o înghețată.', accept: ['ich kaufe mir ein eis'], correct: 'Ich kaufe mir ein Eis.', explanation: 'sich (Dat) etwas kaufen.' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Îmi periez dinții.', accept: ['ich putze mir die zähne'], correct: 'Ich putze mir die Zähne.', explanation: 'mir + die Zähne (articol).' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Ce-ți dorești?', accept: ['was wünschst du dir'], correct: 'Was wünschst du dir?', explanation: 'sich wünschen → du dir.' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Nu îmi pot permite asta.', accept: ['ich kann mir das nicht leisten'], correct: 'Ich kann mir das nicht leisten.', explanation: 'sich (Dat) etwas leisten.' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong> despre reflexivul la Dativ.</p>
            <ul class="test-info-list">
                <li>⚡ Regula (4) · 🫳 Dativ mir/dir (4) · 🪥 Körperteile (3) · 🗣️ Traducere (4)</li>
